                        ...
                        return (
                            ...
                            (e.prototype._onBlur = function (e) {
                                ...
                                if (
                                    ...
                                    var s = this._store.activeItems.some(
                                        function (e) {
                                            return e.highlighted;
                                        }
                                    );
                        ...
                        return (
                            ...
                            (e.prototype._animateScroll = function (e, t) {
                                var i = this,
                                    ...
                                    o = !1;
                                t > 0
                                    ? (this._scrollDown(r, s, e),
                                      r < e && (o = !0))
                                    : (this._scrollUp(r, s, e),
                                      r > e && (o = !0)),
                                    o &&
                                        requestAnimationFrame(function () {
                        ...
                        this.keys.forEach((t, r) => {
                            ...
                            if (a(o))
                                if (n(o)) {
                                    ...
                                    for (; t.length; ) {
                                        const { nestedArrIndex: i, value: r } =
                                            t.pop();
                                        if (a(r))
                                            if (s(r) && !c(r)) {
                                                let t = {
